...
void init_main(void) {
    ...
    print_string(2, 2, " Apex OS Initialization ", 0x1F);
    print_string(4, 2, "System starting up...", 0x0F);
    
    const char* services[] = {
        "-> Initializing Memory Manager...",
        "   Loading Kernel Subsystems...",
        "   Mounting Root Filesystem...",
        "   Starting Apex Shell..."
    };

    for (int i = 0; i < 4; i++) {
        print_string(7 + i, 4, services[i], (i == 0) ? VGA_HIGHLIGHT : 0x07);
    }
